...
For the frontend, at the time of writing this, there is no user registration/ authentication yet. You need to manually register a user in your database and copy & paste the user ID in the `.env` file for the app to work correctly.
